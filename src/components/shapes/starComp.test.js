...
describe("determine corners", () => {
  test("orientation 1", () => {
    expect(determineCorners(1000, 1000, 200, 1)).toEqual([
      [1000, 1000],
      [1175, 875],
      [1375, 1000],
      [1300, 800],
  ...
  test("orientation 2", () => {
    expect(determineCorners(1000, 1000, 200, 2)).toEqual([
      [1000, 1000],
      [1125, 1175],
      [1000, 1375],
      [1200, 1300],
  ...
  test("orientation 3", () => {
    expect(determineCorners(1000, 1000, 200, 3)).toEqual([
      [1000, 1000],
      [825, 1125],
      [625, 1000],
      [700, 1200],
  ...
  test("orientation 4", () => {
    expect(determineCorners(1000, 1000, 200, 4)).toEqual([
      [1000, 1000],
      [875, 825],
      [1000, 625],
      [800, 700],
