...
function determineCorners (anchorX, anchorY, length, orientation) {
    if (orientation === 1) {
        return  [[anchorX, anchorY],[anchorX + 175, anchorY - 125],[anchorX + 375, anchorY],[anchorX + 300, anchorY - 200],[anchorX + 425, anchorY - 350],[anchorX + 250, anchorY - 350],[anchorX + 175, anchorY - 525],[anchorX + 100, anchorY - 350],[anchorX - 75, anchorY - 350],[anchorX + 50, anchorY - 200]];
    }
    if (orientation === 2) {
        return  [[anchorX, anchorY],[anchorX + 125, anchorY + 175],[anchorX, anchorY + 375],[anchorX + 200, anchorY + 300],[anchorX + 350, anchorY + 425],[anchorX + 350, anchorY + 250],[anchorX + 525, anchorY + 175],[anchorX + 350, anchorY + 100],[anchorX + 350, anchorY - 75],[anchorX + 200, anchorY + 50]];
    }
    if (orientation === 3) {
        return  [[anchorX, anchorY],[anchorX - 175, anchorY + 125],[anchorX - 375, anchorY],[anchorX - 300, anchorY + 200],[anchorX - 425, anchorY + 350],[anchorX - 250, anchorY + 350],[anchorX - 175, anchorY + 525],[anchorX - 100, anchorY + 350],[anchorX + 75, anchorY + 350],[anchorX - 50, anchorY + 200]];
    }
