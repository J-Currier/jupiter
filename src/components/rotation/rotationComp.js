  ...
  return (
    <div id="rotation" className="tab">
      ...
      <img 
        ...
        src={rotate} 
        onClick={(e) => props.rotate(e, props.rotationMag, props.pivotPointx, props.pivotPointy, true)}
      ></img>
      <input
        type="number"
        name="setPivotPointx"
      ...
      src={rotate}
      onClick={(e) => props.rotate(e, props.rotationMag, props.pivotPointx, props.pivotPointy, false)}
      ></img>
